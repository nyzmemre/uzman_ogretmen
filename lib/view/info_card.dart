...
class InfoCard extends StatelessWidget {
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          AutoSizeText((switchData.values.first) ? "Yazıyı Küçült 👉👉👉" : "Yazıyı Büyüt 👉👉👉",
              ...
              return Column(
                children: [
                  Row(
                        ...
                        children: [
                        TextButton(onPressed: ()async{await info.decreaseFontSize();}, child: AutoSizeText("-", style: GoogleFonts.beVietnam(
                fontWeight: FontWeight.w900, color: kBlack, fontSize: value.values.first),),),
                        AutoSizeText("${value.values.first.toInt().toString()}", style: GoogleFonts.beVietnam(
                            fontWeight: FontWeight.w900, color: kBlack, fontSize: value.values.first)),
                        TextButton(onPressed: ()async{await info.increaseFontSize();}, child: AutoSizeText("+", style: GoogleFonts.beVietnam(
                fontWeight: FontWeight.w900, color: kBlack, fontSize: value.values.first),))
                      ],),
                    ...
                    child: PageView.builder(
                      itemCount: content.length,
                        ...
                        itemBuilder: (context, int index) => Card(
                              child: infoCardContentWidget(context, index, favoriteButton(index), contentFont: value.values.first),
                            )),
                  ),
                ],
              );
  ...
  Widget infoCardContentWidget(BuildContext context, int index, Widget button, {double? contentFont}) {
    return Card(
      child: Stack(
        children: [
          */
              ...
              children: [
                ...
                AutoSizeText(
                  ...
                  style: GoogleFonts.quicksand(
                    ...
                    color: kBlack,
                    height: 1.4,fontSize: contentFont
                  ),
