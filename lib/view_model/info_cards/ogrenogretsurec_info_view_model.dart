...
class OgrenOgrenSurecInfoViewModel extends ChangeNotifier {
  List<InfoCardModel> _ogrenmeOgretmeSurec = [
    ...
    InfoCardModel("Öğrenme ve Öğretme Süreçleri-9", [
      ...
      InfoCardItem("ogrenogretsurec_info_40", "Alışkanlık kazanma", ""),
      InfoCardItem("ogrenogretsurec_info_41", "Programlanmış öğrenme", ""),
      InfoCardItem("ogrenogretsurec_info_42", "Zincirleme", ""),
      InfoCardItem("ogrenogretsurec_info_43", "Ayırt edici uyarıcı", ""),
    ]),
