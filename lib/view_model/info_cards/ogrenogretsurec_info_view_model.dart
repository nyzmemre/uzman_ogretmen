...
class OgrenOgrenSurecInfoViewModel extends ChangeNotifier {
  List<InfoCardModel> _ogrenmeOgretmeSurec = [
    ...
    InfoCardModel("Öğrenme ve Öğretme Süreçleri-9", [
      ...
      InfoCardItem("ogrenogretsurec_info_48", "Olumsuz Pekiştireç-1", "-Ortamdan çekilen uyarıcı sayesinde istenilen davranışın yapılması sağlanır.\n-Organizmanın kaçtığı bir uyarıcı ortamdan çekilir.\n-Ödevlerini bitiren öğrencinin patlamış topunun yerine sağlam olanının alınması örnektir.\n-Bu örnekte öğrenci için olumsuz durum patlak toptu. Bu ortadan kaldırılarak yeni top ile değiştirildi. Ödev bitirme davranışına olumlu katkı sağlayacaktır."),
