...
class DijitalYetkinlikInfoViewModel extends ChangeNotifier{
  List<InfoCardModel> _dijitalYetkinlikList = [
    ...
    ///   ---------------------------------------------------------------------- Tayfun Başladığı Nokta-----------------------
     ...
     InfoCardModel("Türkiyede Eğitim Alanında Dijital Dönüşüme Yönelik Uygulamalar", [
      ...
      InfoCardItem("hh_dijitalyetkinlik_info_55", "Yükseköğretim Kurumu’nun Çalışmaları", "-Yüksek Öğretim Kurumlarında 2019 yılında başlamış sekiz pilot üniversitenin Üniversitelerde Dijital Dönüşüm Projesi uygulanmaya başlamıştır.\n-Öğrenmede açık eğitsel kaynaklar, yapay zeka, bulut bilişim sistemleri, veri madenciliği çalışmalarına önecelik verilmiştir. "),
      InfoCardItem("hh_dijitalyetkinlik_info_56", "Okul Dışı Eğitim Düzeyindeki Çalışmalar", "-Ülkemizde okul dışı etkinliklerde bilim merkezlerirde\n-Robotik Ve Kodlama\n-Elektronik Ve Proğramlama\n-Tasarım gibi eğitim atalyöleri düzenlenmeye başlandığı görülmektedir. "),
    ...
    /// ------------------------------------------
     ...
     InfoCardModel("Dijital Okuryazarlık", [
       ...
       InfoCardItem("hh_dijitalyetkinlik_info_59", "Dijital Okuryazarlığın Bileşenleri", "Dijital okuryazarlık E-güvenlik, Kültürel ve sosyal farkındalık, Foksiyonel beceriler, Yaratıcı düşünme, Bilgi İletişim Teknolojileri, Eleştirisel düşünme ve değerlendirme, iş birliği, Bilgiyi bulma ve seçme yeteneği tüm bu bileşenlerin çakıştığı alan olarak tanımlanmaktadır."),
  ...
  /// ----------------------------------------------
     ...
     InfoCardModel("Etik Dijital Okuryazarlık", [
      ...
      InfoCardItem("hh_dijitalyetkinlik_info_64", "Parolalar", "Öğrenciler güçlü parola oluşturmanın önemi hakkında bilgi verilmeli ve onlara güvenli paroların ve sistemlerin nasıl oluşturacağı hakkında bilgi verilmelider."),
