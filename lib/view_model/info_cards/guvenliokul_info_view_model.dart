...
class GuvenliOkulInfoViewModel extends ChangeNotifier{
  List<InfoCardModel> _guvenliOkulList = [
    InfoCardModel("Genel Bakış", [
      InfoCardItem("guvenliokul_info_1", "", "-Şiddet olgusu insanlık tarihi kadar eskidir ve bu olgu yüzyıllardır insanlığın en temel sorunlarından birisi olmuştur.\n-Bu tür sorunların okullarda yaşanmaması söz konusu değildir. "),
      InfoCardItem("guvenliokul_info_2", "", "-Güvenlik tanımının yeniden yapıldığı, bireylerin kendilerini daha güvensiz hissettiği bu çağda, okullarda yaşanan şiddet olayları ve güvenlik ihlalleri, şiddetin önlenmesi ve okul paydaşları için güvenliğin sağlanmasını tüm dünya için çok önemli bir konu haline getirmiştir.\n-Okulların temel görevlerinden biri de öğrencilerin, istenmeyen davranışlardan arındırılması, kendilerini güvende hissetmeleri ve okulda güvenliklerinin sağlanmasıdır."),
