...
class DijitalYetkinlikQuesViewModel extends ChangeNotifier{
  ...
  List<TestListHomepageModel> _dijitalYetkinlikList=[
    TestListHomepageModel("Dijital Yetkinlik-Karışık Test Çöz",[
      ...
      Question("dijitalyetkinlik_ques_Q38","", "Aşağıdakilerden hangisi bilişim teknoloji araçlarının eğitimde kullanımı ile ilgili doğru bir ifade değildir?", "İletişim yönü tek taraflıdır", ["İletişim yönü tek taraflıdır","Öğrenme sürecini destekler","Materyaller kullanılır","Online eğitimi destekler","Heryerde eğitimi sağlar"]),
