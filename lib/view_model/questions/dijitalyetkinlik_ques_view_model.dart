...
class DijitalYetkinlikQuesViewModel extends ChangeNotifier{
  ...
  List<Question> _dijitalYetkinlikList=[
    ...
    Question("dijitalyetkinlik_ques_Q10","Öğrencilerin araştırma ödevlerini yaparken zorlandıklarını fark eden Kazım öğretmen, öğrencilerinin bu alanda teknolojiyi doğru kullanamadıklarını farketmiştir.", "Öğrencilerine doğru teknoloji kullanımını öğretmen isteyen Kazım öğretmenin, aşağıdaki yeterliliklerden hangisini öğrencilerine kazandırması gerekmektedir?","Dijital Yetkinlik",["Dijital Yetkinlik","Ödev Sorumluluğu","Araştırma Becerileri","Farkındalık Eğitimi","Sosyal Sorumluluk"]),
