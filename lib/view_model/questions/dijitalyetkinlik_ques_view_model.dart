...
class DijitalYetkinlikQuesViewModel extends ChangeNotifier{
  ...
  List<TestListHomepageModel> _dijitalYetkinlikList=[
    TestListHomepageModel("Dijital Yetkinlik-Karışık Test Çöz",[
      ...
      Question("dijitalyetkinlik_ques_Q4","", "Soyut olarak sanal ortamlarda var olan tüm doküman ve belgeler aşağıdaki terimlerden hangisi ile ifade edilir?","Dijital",["Donanım","Dijital","Teknoloji","Ağ","Sanallaştırma"]),
      ...
      Question("dijitalyetkinlik_ques_Q9","", "Aşağıdakilerden hangisi dijital yetkinlik kapsamında sahip olunması gereken özelliklerdendir?","Var olan bilgilerini yeni öğrenmelerinde kullanarak sentez yapar",["Yeni öğrenmelere karşı mesafelidir","Bilginin üretilmesi sürecinde pasiftir","Gerçek dünyadaki tecrübelerini sanal dünyaya taşımaz","Dijital ilkelere göre değil kendi tasarruflarına göre hareket eder","Var olan bilgilerini yeni öğrenmelerinde kullanarak sentez yapar"]),
      ...
      Question("dijitalyetkinlik_ques_Q13","I-Tutum\nII-Söylem\nIII-Kazanım", "Yukarıdakilerden hangisi veya hangileri dijital yetkinliğin temel unsurları arasında yer almaz?","II-III", ["Yalnız I","Yalnız II","Yalnız III","II-III","I-II-III"]),
      ...
      Question("dijitalyetkinlik_ques_Q22","Sınıfta varlığı pek fark edilmeyen Elif'in arkadaşları ile duygu, düşünce ve bilgisini paylaşmada yeterli olmadığı sınıf öğretmeni tarafından fark edilmiştir.", "Sınıf öğretmeni, Elif'in aşağıdaki becerilerinden hangisini arttırmaya yönelik çalışmalar yapması gerekmektedir?","İletişim",["Sosyal sorumluluk","Fedakarlık","İletişim","Samimiyet","Özbakım becerisi"]),
      ...
      Question("dijitalyetkinlik_ques_Q25","Günümüzde yaygın olarak kullanılan dijital mesajlaşma uygulamaları ile simgelerle iletişim yaygınlaşmıştır.", "Aşağıdakilerden hangisi simgelerle iletişimin olumsuz yanlarından birisi olarak değerlendirilebilir?","Yanlış anlaşılmalara açık olması",["Anlatılmak istenen düşünceyi pekiştirmesi","Anlatımı görsel hale getirebilmesi","İfadeyi basitleştirmesi","Yanlış anlaşılmalara açık olması","İçeriğe kolayca eklenebilmesi"]),
      ...
      Question("dijitalyetkinlik_ques_Q38","", "Aşağıdakilerden hangisi bilişim teknoloji araçlarının eğitimde kullanımı ile ilgili doğru bir ifade değildir?", "İletişim yönü tek taraflıdır", ["İletişim yönü tek taraflıdır","Öğrenme sürecini destekler","Materyaller kullanılır","Online eğitimi destekler","Her yerde eğitimi sağlar"]),
      Question("dijitalyetkinlik_ques_Q39","", "İki veya daha fazla kişinin, internet ortamından birbirlerine metin, resim, dosya veya farklı ekler içererek gönderilebilen mesaj sistemi aşağıdakilerden hangisidir?", "e-Posta", ["Sosyal mesaj","Kurumsal mesaj","e-Direct","e-Posta","e-Sms"]),
